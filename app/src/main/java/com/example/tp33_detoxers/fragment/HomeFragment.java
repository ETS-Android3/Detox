...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        urls.add("https://images.unsplash.com/photo-1542884748-2b87b36c6b90?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80");
        urls.add("https://cdn.pixabay.com/photo/2019/12/09/15/20/fast-food-4683707_960_720.jpg");
        urls.add("https://cdn.pixabay.com/photo/2018/03/09/17/39/paprika-3212137_960_720.jpg");
        titles.add("High Blood Sugar");
        titles.add("High Blood Pressure");
        titles.add("High Cholesterol");
